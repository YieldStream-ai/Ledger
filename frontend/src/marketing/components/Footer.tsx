      ...
      <Container>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-[var(--border)] pt-8 md:flex-row">
          <div className="flex items-center gap-3">
            <span className="text-sm font-semibold text-[var(--text-primary)]">Ledger</span>
            <span className="text-xs text-[var(--text-tertiary)]">{footer.copyright}</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Social icons */}
            <a
              href="https://github.com/yieldstream"
